// Dafny program radix_sort.dfy compiled into C#
...
// Command-line arguments: run --no-verify /Users/rahinjain/Documents/GitHub/CS-472-Dafny-Python-Sorting-Algos-Verification/dafny_files/radix_sort.dfy
// radix_sort.dfy
  ...
  decreases arr
{
  ...
  while Pow(10, digit_place) <= max
    ...
    decreases max - Pow(10, digit_place)
  {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      if ((exp).Sign == 0) {
        ...
        _0___accumulator = (_0___accumulator) * (@base);
        BigInteger _in0 = @base;
        BigInteger _in1 = (exp) - (BigInteger.One);
        @base = _in0;
        exp = _in1;
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger[] _1_radix__sort__test;
      BigInteger[] _out0;
      _out0 = __default.RadixSort(_0_arr);
      _1_radix__sort__test = _out0;
      Dafny.Helpers.Print((_1_radix__sort__test));
    }
    public static BigInteger[] RadixSort(BigInteger[] arr)
    {
      BigInteger[] new__arr = new BigInteger[0];
      BigInteger _0_max;
      BigInteger _out0;
      _out0 = __default.ArrayMaxNumber(arr);
      _0_max = _out0;
      BigInteger _1_digit__place;
      _1_digit__place = BigInteger.Zero;
      BigInteger[] _2_sorted;
      _2_sorted = arr;
      while ((__default.Pow(new BigInteger(10), _1_digit__place)) <= (_0_max)) {
        BigInteger[] _out1;
        _out1 = __default.CountingSort(_2_sorted, _1_digit__place);
        _2_sorted = _out1;
        _1_digit__place = (_1_digit__place) + (BigInteger.One);
      }
      new__arr = _2_sorted;
      new__arr = new__arr;
      return new__arr;
    ...
    public static BigInteger[] CountingSort(BigInteger[] arr, BigInteger digit__place)
    {
      BigInteger[] new__arr = new BigInteger[0];
      BigInteger _0_n;
      _0_n = new BigInteger((arr).Length);
      BigInteger[] _1_output;
      BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(_0_n, "array size exceeds memory limit")];
      _1_output = _nw0;
      BigInteger[] _2_count;
      BigInteger[] _nw1 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(10), "array size exceeds memory limit")];
      _2_count = _nw1;
      BigInteger _3_i;
      ...
      while ((_3_i) < (_0_n)) {
        ...
        _4_num = (arr)[(int)(_3_i)];
        BigInteger _5_pow;
        _5_pow = __default.Pow(new BigInteger(10), digit__place);
        BigInteger _6_digit;
        _6_digit = Dafny.Helpers.EuclideanModulus(Dafny.Helpers.EuclideanDivision(_4_num, _5_pow), new BigInteger(10));
        (_2_count)[(int)((_6_digit))] = ((_2_count)[(int)(_6_digit)]) + (BigInteger.One);
        _3_i = (_3_i) + (BigInteger.One);
      }
      _3_i = BigInteger.One;
      while ((_3_i) < (new BigInteger(10))) {
        (_2_count)[(int)((_3_i))] = ((_2_count)[(int)(_3_i)]) + ((_2_count)[(int)((_3_i) - (BigInteger.One))]);
        _3_i = (_3_i) + (BigInteger.One);
      }
      _3_i = (_0_n) - (BigInteger.One);
      while ((_3_i).Sign != -1) {
        BigInteger _7_num;
        _7_num = (arr)[(int)(_3_i)];
        BigInteger _8_pow;
        _8_pow = __default.Pow(new BigInteger(10), digit__place);
        BigInteger _9_digit;
        _9_digit = Dafny.Helpers.EuclideanModulus(Dafny.Helpers.EuclideanDivision(_7_num, _8_pow), new BigInteger(10));
        (_2_count)[(int)((_9_digit))] = ((_2_count)[(int)(_9_digit)]) - (BigInteger.One);
        BigInteger _index0 = (_2_count)[(int)(_9_digit)];
        (_1_output)[(int)(_index0)] = _7_num;
        _3_i = (_3_i) - (BigInteger.One);
      }
      new__arr = _1_output;
      new__arr = new__arr;
